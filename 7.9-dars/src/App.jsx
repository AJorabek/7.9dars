...
import { Layout, Menu, Button, theme, Form, Select, Input } from "antd";
const { Header, Sider, Content } = Layout;
const App = () => {
  const [collapsed, setCollapsed] = useState(false);
  const {
          ...
          >
            ...
            <defs>
              <clipPath id="logo_svg__a">
                <path fill="#fff" d="M0 0h214v46H0z"></path>
              </clipPath>
            </defs>
          </svg>
          <h3
        ...
        >
          <div className="content">
            <div className="first-wrapper">
              <div>
                <h3 style={{ marginBottom: 10 }}>Guruh nomi</h3>
                <Input
              ...
              <div>
                <h3 style={{ marginBottom: 10 }}>Holati</h3>
                <Form.Item
                  label="Select"
                  style={{
                    width: 200,
